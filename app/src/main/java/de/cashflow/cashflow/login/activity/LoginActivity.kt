...
import de.cashflow.cashflow.login.repository.UserRepositoryImpl
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checker = CredentialChecker(ShaHasher(), usernameInputField, passwordInputField, UserRepositoryImpl())
